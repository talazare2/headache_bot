...
DIALOG_RU: Dict[str, str] ={
        ...
        'localisation': 'Ок. Посмотрите на картинки и выберите номер от 1-6, соответстующий типу' 
                        'локализации вашей боли, независимо от ориентации (лево - право)',
...
DIALOG_EN: Dict[str, str] ={
        ...
        'localisation': 'Ok. What is localisation of your headache?  Regardless left/right orientation,'
                        ' choose from 1 to 6 based on the picture',
...
DIALOG_FR: Dict[str,str] = {
        ...
        'localisation': 'D\'accord. Regardez les images et choisissez le numéro qui '
                        'correspond à la localisation de votre douleur. Droit ou gosh ce n\'est pas important',
